        ...
        <>
            <section className="mb-8 animate-in fade-in duration-500">
                <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center mb-6 gap-4">
                    <h3 className="text-xs font-black text-text-light dark:text-text-dark uppercase tracking-wider flex items-center gap-2">
                        <span className="w-1.5 h-1.5 rounded-full bg-primary"></span>
                        Métricas Principais
                    </h3>

                    <div className="flex flex-col sm:flex-row gap-4 w-full xl:w-auto">
                        <div className="flex items-center bg-card-light dark:bg-card-dark p-1 rounded-lg border border-gray-200 dark:border-border-dark shadow-sm w-full sm:w-auto overflow-x-auto">
                        ...
                        {timeRange === 'custom' && (
                            <div className="flex items-center gap-2 bg-card-light dark:bg-card-dark p-1 rounded-lg border border-gray-200 dark:border-border-dark shadow-sm animate-in slide-in-from-right-4 duration-300">
                                <div className="relative">
                                    <input
                                        type="date"
                                        value={startDate}
                                        onChange={(e) => setStartDate(e.target.value)}
                                        className="text-xs font-medium bg-transparent border-none text-text-light dark:text-text-dark focus:ring-0 p-1.5"
                                    />
                                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                    ...
                    <div className="col-span-1">
                        <div className="h-full min-h-[140px] flex flex-col justify-center items-center bg-card-light dark:bg-card-dark rounded-xl border border-border-light dark:border-border-dark hover:shadow-md transition-shadow duration-200 p-6 relative overflow-hidden group">
                ...
                <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                    ...
                    <div className="bg-card-light dark:bg-card-dark p-6 rounded-xl border border-border-light dark:border-border-dark shadow-sm flex flex-col h-full">
                        <div className="flex justify-between items-center mb-6">
                            <h3 className="text-lg font-bold text-text-light dark:text-text-dark">Atividade Recente</h3>
