    ...
    <header className="flex flex-col md:flex-row justify-between items-start mb-6 md:mb-8 gap-4">
      <div className="flex items-start gap-3 w-full md:w-auto">
        ...
        <div className="flex-1">
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-text-light dark:text-text-dark tracking-tight">
            {title}
          </h2>
      ...
      <div className="flex items-center gap-3 w-full md:w-auto justify-end">
        ...
        <button
          onClick={toggleTheme}
          className="p-2.5 rounded-full bg-card-light dark:bg-card-dark border border-border-light dark:border-border-dark hover:bg-gray-50 dark:hover:bg-muted-dark transition-all text-gray-600 dark:text-gray-400 shadow-sm"
